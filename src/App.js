    ...
    <div className="App">
      <Routes>
        <Route element={<Header userId={userId} setUserId={setUserId} />}>
          ...
          <Route
            path="/register"
            element={<AuthPage componentName={"register"} />}
          />
          <Route
            path="/myplan/:plan_id"
            element={
          ...
          <Route
            ...
            element={
              <SetPlanContainer
                setUserId={setUserId}
                componentName={"DndContainer"}
              />
            }
          />
          <Route
            path="/mypage"
            element={<MyPageContainer setUserId={setUserId} />}
          />
          <Route
            path="/publicplan/:plan_id"
            element={<PublicPlan userId={userId} />}
          />
