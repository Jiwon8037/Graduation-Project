...
const ResultMapRander = ({ placeData }) => {
  ...
  useEffect(() => {
    ...
    for (i = 0; i < mapRandersPlaceData.length; i++) {
      ...
      var iwContent = `<div style="padding:8px;white-space:nowrap;">${
          i + 1
        } : ${place_name}<br><a href="https://map.kakao.com/?map_type=TYPE_MAP&target=transit&rt=${
          ",," + WTM.La + "," + WTM.Ma
        }&rt1=${temp}&rt2=${place_name}&rtIds=%2C&rtTypes=%2C" style="color:blue" target="_blank">길찾기</a></div>`,
